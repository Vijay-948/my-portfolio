...
const Skills = () => {
    ...
    return (
        ...
        <section id="skills" className="py-10 px-5 md:px-20 min-h-screen flex flex-col items-center bg-gray-600">
            ...
            <div className="grid grid-cols-3 md:grid-cols-7 gap-10">
                {languageandTools.map((item) => (
                    <div className="text-center">
                        <img className= " rounded-full w-24 mx-auto mb-3 transform transition-transform hover:scale-105 hover:shadow-2xl hover:bg-gray-700" src={item.logo} alt={item.name} />
