    ...
    return (
        <section id='coding-profile'>
            ...
            <VerticalTimelineElement
                    ...
                    iconStyle={{ backgroundImage: `url(${github})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', cursor:'pointer' }}
                >
                    ...
                    <p className='link-tag' style={{textAlign: 'right'}}>
                        <a href={`https://github.com/Vijay-948/`} className="links">
                            View Profile <LaunchIcon className='icon' sx={{width: '15px', height:'15px', color:'black'}}/>
                        </a>
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                    ...
                    contentStyle={{ background: '#e6e6e5', color: 'black' }}
                    contentArrowStyle={{ borderRight: '7px solid  rgb(33, 150, 243)' }}
                    iconStyle={{ backgroundImage: `url(${leetcode})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', cursor:'pointer' }}
                >
                    ...
                    <p className='link-tag' style={{textAlign: 'right'}}>
                        <a href="https://leetcode.com/u/vijay_948/" className="links">
                            View Profile <LaunchIcon sx={{width: '15px', height:'15px', color: 'black'}} className='icon'/>
                        </a>
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
